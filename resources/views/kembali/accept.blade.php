        ...
        <!-- Konten -->
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-4">
                            ...
                            @if (empty($pinjam[0]->kembali))
                                <input id="txtDenda" type="text" class="form-control" placeholder="Denda" value="{{ $denda }}" readonly>
                            @else
                        ...
                        <div class="form-group col-md-4">
                            ...
                            @if (empty($pinjam[0]->kembali))
                                <input type="text" class="form-control" id="txtBayar" placeholder="Bayar" value="" required readonly>
                            @else
            ...
            <div class="modal-footer">
                <div class="btn-group" role="group">
                    <button type="button" id="btnSaveAccept" class="btn btn-outline-primary"><i class="fas fa-check-circle"></i> Accept</button>
...
<script>
            ...
            function calculate() {
                ...
                denda *= c;
                bayar = parseFloat($('#txtTotal').val()) + denda;
                $('#txtDenda').val(denda);
                $('#txtBayar').val(bayar);
            };
